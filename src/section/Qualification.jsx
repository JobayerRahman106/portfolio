  ...
  return (
    <div className='py-16'>
        <div>
            ...
            <p className='px-4 max-w-3xl mx-auto  text-white mt-6 leading-6 lg:leading-7 text-sm lg:text-base text-justify lg:text-center'>I’m currently studying Computer Science & Engineering (CSE) , where I'm developing a solid base in programming, problem-solving, and modern technologies. My academic journey inspires me to keep learning, improving, and preparing for exciting opportunities in the tech world.</p>
        </div>
